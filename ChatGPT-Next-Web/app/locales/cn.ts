...
const cn = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 XJUSpeech AI 首发优惠，立刻解锁 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "使用 XJUSpeech AI",
        Label: "（性价比最高的方案）",
        SubTitle:
          "由 XJUSpeech 官方维护, 零配置开箱即用，支持 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
        ChatNow: "立刻对话",
      },
      AccessCode: {
        Title: "访问密码",
